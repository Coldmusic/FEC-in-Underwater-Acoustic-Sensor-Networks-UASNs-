    ...
    if Nsd > 1
        for isd = 1:Nsd
            for ird = 1:Nrd
                for ir = 1:Nrr
                    ...
                    if numarr>0;
                        p( 1, isd, ir, ird ) = Arr.A( ir, 1:numarr, ird, isd ) * ...
        ...
        for ird = 1:Nrd
            for ir = 1:Nrr
                ...
                if numarr>0;
                    p( 1, 1, ird, ir ) = Arr.A( ir, 1:numarr, ird ) * ...
        ...
        eval( [ 'save ' outfilename ' PlotTitle PlotType freq atten Pos p' ] );
    end
end %freq
