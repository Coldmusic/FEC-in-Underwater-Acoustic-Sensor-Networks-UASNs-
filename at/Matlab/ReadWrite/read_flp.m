function [ TitleEnv, Opt, Comp, MLimit, NProf, rProf, R, Pos ] = read_flp
...
fid = fopen( 'field.flp', 'r' );    % open the field parameters file
if ( fid == -1 )
   errordlg( 'field.flp file does not exist', 'read_flp' )
   error(    'field.flp file does not exist', 'read_flp' )
end
