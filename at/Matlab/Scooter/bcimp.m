...
case 'F'   %     *** Tabulated reflection coefficient ***
   ...
   if ( strcmp( BotTop(1:3), 'TOP' ) )
      RInt   = interp1q( thetaTop, RTop,   real( thetaInt ), 'linear', 'extrap' );   % Linear interpolation for reflection amplitude
      phiInt = interp1q( thetaTop, phiTop, real( thetaInt ), 'linear', 'extrap' );   % Linear interpolation for reflection phase
