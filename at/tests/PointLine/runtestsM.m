...
plotshd( 'LloydPoint_gbtB.mat', 2, 2, 1 );
caxisrev( [ 40 80 ] )
colorbar( 'YDir', 'Reverse' )
...
plotshd( 'LloydLine_gbtB.mat', 2, 2, 2 );
caxisrev( [ 0 25 ] )
colorbar( 'YDir', 'Reverse' )
